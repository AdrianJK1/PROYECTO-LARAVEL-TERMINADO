            ...
            @foreach ($estudiantes as $item)
                <tr>
                    ...
                    <td>
                        <table>
                            <td>
                                <a href="{{ route('estudiantes.edit', $item->id) }}" class="btn btn-warning">Editar</a>
                            </td>
                            <td>
                                <a href="{{ route('estudiantes.show', $item->id) }}" class="btn btn-info">Ver</a>
                            </td>
                            <td>
                                <a href="{{ route('estudiantes.delete', $item->id) }}" class="btn btn-danger">Eliminar</a>
                            </td>
                        </table>
